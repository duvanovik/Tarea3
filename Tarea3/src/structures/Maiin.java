...
public class Maiin {
	...
	public static void main(String[] args) {
        ...
        ArrayList<ArrayList<String>> cam = g.caminos("Leticia","Bucaramanga");
        JOptionPane.showMessageDialog(null, "tamanio "+cam.size());
		...
		//System.out.println(g.dijkstraCaminoCorto("Mocoa", "Bucaramanga")+" ");
	}
